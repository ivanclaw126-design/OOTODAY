      ...
      <div className="space-y-5">
        ...
        <div className="overflow-hidden rounded-[2rem] bg-[var(--color-panel)] text-white shadow-[var(--shadow-strong)]">
          <div className="space-y-3 p-6 sm:p-7">
            ...
            <p className="max-w-lg text-3xl leading-[0.94] font-semibold tracking-[-0.06em] sm:text-4xl">今天穿什么，先用一眼能做决定的方式告诉你。</p>
            <p className="max-w-2xl text-sm leading-6 text-white/72 sm:text-base">{summary}</p>
          </div>
          ...
          <div className="grid gap-px bg-white/8 sm:grid-cols-[1.1fr_0.9fr]">
            ...
            <div className="bg-white/4 px-6 py-5">
