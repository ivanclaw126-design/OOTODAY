  ...
  return (
    ...
    >
      ...
      >
        <div
          aria-hidden="true"
          className="pointer-events-none absolute bottom-1.5 top-1.5 rounded-[1.12rem] bg-[linear-gradient(180deg,rgba(26,26,26,0.1)_0%,rgba(26,26,26,0.05)_100%)] shadow-[0_1px_0_rgba(255,255,255,0.76)_inset,0_8px_18px_rgba(26,26,26,0.06)] transition-[left,width,opacity] duration-200 ease-out"
          style={{
